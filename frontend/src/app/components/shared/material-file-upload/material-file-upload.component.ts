...
export class MaterialFileUploadComponent implements OnInit {
  /** Link text */
      ...
      @Input() target = 'http://localhost:4000/api/user/editProfile';
      ...
      constructor(private _http: HttpClient, _userService:UserService, private jwtHelp:JwtHelperService) { }
      ...
      private uploadFile(file: FileUploadModel) {
            ...
            const req = new HttpRequest('PATCH', `${this.target}/:${userId}`, fd, {
                  reportProgress: true
            });
